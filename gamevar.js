...
const MY_IP = "https://proxy-reza-kontolodon-memek.up.railway.app/"; // FIX: tambah trailing slash
...
function getVerConfig(clientIp = "74.125.24.139", myDomain = MY_IP) {
  ...
  // FIX: myDomain sudah ada trailing slash, jadi langsung concat
  ...
  return {
    ...
    "garena_hint": true,       // FIX: duplikat dihapus, sisakan sekali
    "garena_login": true,      // FIX: duplikat dihapus, sisakan sekali
    "gdpr_version": 0,
...
// FIX: export semua yang mungkin dipakai file lain
