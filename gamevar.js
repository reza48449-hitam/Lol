// gamevar.js
// Format mengikuti struktur asli Garena dari JSON capture:
// - Header dobel (baris 0 dan 1) — sama persis kayak response Garena
// - Urutan var ikutin Garena, value di-override sesuai kebutuhan proxy
// - Var yang ga dikenal Garena ga dimasukin (HitBoxScale, AimAssist, dll ga efek)

const gamevarLines = [
  // Header dobel — WAJIB, Garena selalu kirim 2x
  "var_name,comment,var_type,var_value,var_region,var_platform",
  "var_name,comment,var_type,var_value,var_region,var_platform",

  // === UGC / MISC (valid dari log Garena asli) ===
  ...
  // TurnSpeed & ActionSpeedScale — dikonfirmasi dari log 16:30 (proxy lain pakai ini)
  ...
  // === UNLOCK (dikonfirmasi dari log 16:30) ===
  // EnableAllSkins & UnlockAllEmotes terdeteksi di proxy lain yang aktif
...
function getVerConfig(clientIp = "74.125.24.139", myDomain = MY_IP) {
  ...
  return {
    ...
    "billboard_bg_url": CDN_BASE + "common/OB23/version/Patch_Bg.png",
...
module.exports = { getVerConfig, REDIRECT_URL, ALLOWED_IPS, MY_IP };
