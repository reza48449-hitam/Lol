...
const INJECTED_MAILS = [
    buildFakeMail(
        ...
        'Hai Survivor!\n\nIni hadiah login harian spesial untukmu dari Mimin [FF00FF]Reza. [FFFFFF]Semangat main ya! \n\nSalam Booyah! ',
        5000,    // 50 gems/diamond
        5000,  // 5000 coins
        [
            { item_id: 907092407, item_num: 5000,  item_type: 1, expire_time: 0 },  // 50 diamonds
            { item_id: 500000003, item_num: 99,   item_type: 1, expire_time: 0 },  // skin item
        ]
    ),
    buildFakeMail(
        9000000002,
    ...
    buildFakeMail(
        ...
        0, 0,
        [
            { item_id: 710051008, item_num: 100, item_type: 1, expire_time: 0 }, // coins
        ]
    ),
];
